...
<div id="<?php echo $item['id']; ?>" class="pet-item">
    <p class="pet-image"><img src="/<?php echo $item['image']; ?>"></p>
    ...
    <?php endif; ?>
    <?php if ((new User())->isAdmin()) : ?>
        <button type="submit" class="delete-item" onclick="window.location.href='/pet/delete/<?php echo $item['id']; ?>'">Видалити</button>
        <button type="submit" class="edit-item" onclick="window.location.href='/pet/update/<?php echo $item['id']; ?>'">Змінити</button>
    <?php endif; ?>
</div>
<?php endforeach; ?>
<?php endif; ?>
